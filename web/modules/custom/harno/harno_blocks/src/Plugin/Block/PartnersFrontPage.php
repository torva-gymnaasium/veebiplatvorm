 ...
 *
 * @Block(
 *   id = "harno_front_page_partners_block",
 *   admin_label = @Translation("Partners"),
 *   category = @Translation("harno_blocks")
 * )
 */
class PartnersFrontPage  extends  BlockBase{
...
//      dump($content);
      ...
      if (isset($media) && $media->hasTranslation($language)){
