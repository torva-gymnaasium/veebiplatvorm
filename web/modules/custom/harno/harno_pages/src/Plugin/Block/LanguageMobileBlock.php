...
namespace Drupal\harno_pages\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "language_mobile_block",
 *   admin_label = @Translation("Language switcher mobile"),
 *   category = @Translation("System"),
 *   deriver = "Drupal\harno_pages\Plugin\Derivative\LanguageMobileBlock"
 * )
 */
class LanguageMobileBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if (isset($links->links)) {
      $build = [
        '#theme' => 'links__language_block_mobile',
        '#links' => $links->links,
        '#attributes' => [
          'class' => [
